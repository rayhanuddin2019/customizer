...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Skyrocket_Single_Accordion_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', TS_JS . '/inc/customizer-custom-controls/js/customizer.js', array( 'jquery' ), '1.0', true );
         wp_enqueue_style( 'skyrocket-custom-controls-css', TS_CSS . '/inc/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_style( 'fontawesome', TS_JS . '/inc/customizer-custom-controls/css/font-awesome.min.css', array(), '4.6.3', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	...
	class Skyrocket_Slider_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', TS_JS . '/inc/customizer-custom-controls/css/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
         wp_enqueue_style( 'skyrocket-custom-controls-css', TS_CSS . '/inc/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	...
	class Skyrocket_Sortable_Repeater_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', TS_JS . '/inc/customizer-custom-controls/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
         wp_enqueue_style( 'skyrocket-custom-controls-css', TS_CSS . '/inc/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends Skyrocket_Custom_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'skyrocket-custom-controls-js', TS_JS . '/inc/customizer-custom-controls/js/customizer.js', array( 'skyrocket-select2-js' ), '1.0', true );
         wp_enqueue_style( 'skyrocket-custom-controls-css', TS_CSS . '/inc/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
	...
	class Skyrocket_Google_Font_Select_Custom_Control extends Skyrocket_Custom_Control {
		...
		public function skyrocket_getGoogleFonts( $count = 30 ) {
			...
			$fontFile = TS_INC . '/customizer-custom-controls/inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = TS_INC . '/customizer-custom-controls/inc/google-fonts-popularity.json';
			}
